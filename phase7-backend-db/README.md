...
**Phase 5 と Phase 6 の両方を修了していることが必須です。**(この 2 つは順不同ですが、ここへ来るまでに両方を終えてください)
...
プロジェクト後に [Phase 7 実技試験](assessment/)を受験します。CRUDの実装数ではなく、認可、冪等性、競合更新、paginationという本番で壊れやすい境界を評価します。
