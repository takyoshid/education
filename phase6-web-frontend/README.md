...
>
> 先に画面が出るものを作りたいなら、Phase 2 の直後にここへ来て構いません。仕組みを固めてから応用したいなら Phase 5 を先にしてください。
> 
> **ただし「どちらか片方でよい」という意味ではありません。**Phase 7 へ進むまでに、5 と 6 の両方を修了してください。
>
> なお面接演習の**進め方の練習**は、Phase 5 を待たず Phase 2 修了後から始められます。**パターン演習は Phase 5 の該当レッスン後です。**
