...
もう一つの見どころは、**インフラ構成が「手順書」から「宣言」に変わる**ことです。「あれをインストールして、次にこれを起動して…」という壊れやすい手順の羅列ではなく、「あるべき編成はこれ」という宣言を書く。これは Phase 7 の SQL(宣言型)で触れた考え方の再登場であり、この先の Infrastructure as Code という大きな潮流の入口でもあります。
