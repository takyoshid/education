# Phase 10: インフラ・クラウド・Docker・CI/CD・セキュリティ
...
`project/` ディレクトリに、Phase 7 で作成した API を題材にした総仕上げ課題があります。
...
全レッスンとプロジェクトの後に [Phase 10 実技試験](assessment/)を実施します。未知の障害について、変更前に仮説を立て、安全にrollbackし、証拠付きpostmortemと再発防止へつなげられることを評価します。
