...
1. ポートフォリオでコード量より「解決した問題」を示すべき理由は何ですか？
2. 初見の閲覧者がREADMEから確認できるべき情報を5つ挙げてください。
3. デモURL、スクリーンショット、動画はそれぞれどのような証拠になりますか？
4. 技術的な挑戦を数字で説明する例を1つ作ってください。
5. ADRをポートフォリオに含めると、どの能力を示せますか？
