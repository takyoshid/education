...
2021年4月、NASA のヘリコプター Ingenuity が火星で初飛行に成功した直後(Phase 8 で詳しく登場します)、世界中の約1万2千人の開発者の GitHub プロフィールに、見覚えのないバッジが突然付与されました — 「**Mars 2020 Helicopter Mission Contributor**」。
