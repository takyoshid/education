...
## 💡 コラム: 世界の技術界は「訛った英語」で回っている

Ruby on Rails の作者 DHH はデンマーク人。Linux のリーナスはフィンランド人。TypeScript を生んだヘルスバーグもデンマーク出身。Google、Microsoft の CEO はインド出身 — 世界のソフトウェア業界を動かしている英語の多くは、**アクセントのある、非ネイティブの英語**です。

国際的な開発チームでは、非ネイティブのほうが多数派であることも珍しくありません。つまり「完璧な発音の英語」は、そもそも現場の標準ではないのです。あなたの日本語アクセントの英語は、その多様なアクセントの一つとして、何の問題もなく受け入れられます。

**本当に恐れるべきは、訛りではなく沈黙です。** 会議で30分黙っている人は、チームにとって「いない人」と同じになってしまいます。たどたどしくても「Wait, I have a question」「I don't understand the second point」と言える人は、確実にチームの一員です。

実践的な武器も一つ: 聞き取れなかったとき、「Sorry?」だけでなく「**Do you mean ~ ?(つまり〜ということですか?)**」と自分の理解を差し出して確認する。相手は Yes/No で答えられ、会話は前に進み、あなたのリスニングの穴は会話の中で自然に埋まっていきます。
