...
## 🌟 コラム: ニューヨーク近代美術館に収蔵された、12×12ピクセル

1999年、NTT ドコモの携帯電話サービス「i モード」のために、栗田穣崇という若いデザイナーが**176個の小さな絵文字**をデザインしました。使えるのはわずか **12×12 ピクセル**。ハート、太陽、傘、笑顔 — 極限まで切り詰められたドット絵です。目的は、短いメールで感情のすれ違いを減らすことでした。

それから17年後の2016年。この最初の176個の絵文字セットは、ピカソやゴッホを収蔵する**ニューヨーク近代美術館(MoMA)の永久コレクション**に加わりました。日本の携帯電話文化から生まれた「emoji」は Unicode に採録されて全人類の共通言語となり、デザインの歴史的達成として美術館に飾られたのです。

このレッスンで学んだ文字コードの物語の、これが最新章です。文字とは、人類が感情と意味を運ぶために発明し続けてきた器 — あなたがプログラムで扱う str 型の中には、楔形文字から12×12のハートまで、その全歴史が流れ込んでいます。
