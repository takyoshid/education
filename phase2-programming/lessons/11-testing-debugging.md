...
## 💡 コラム: スミソニアン博物館に保存された「バグ第1号」

1947年、ハーバード大学の計算機 Mark II が誤動作を起こしました。調査したグレース・ホッパーのチームがリレー(継電器)の中から見つけたのは — **本物の蛾**。チームは日誌にその蛾をセロテープで貼り付け、こう書き添えました。「**First actual case of bug being found**(バグの実物が発見された最初の事例)」。

この日誌は現在、スミソニアン博物館に実物が保存されています。「バグ」という言葉自体はエジソンの時代から機械の不具合を指して使われていましたが、このユーモアあふれる記録が、コンピュータの「バグ」「デバッグ」を伝説にしました。

この逸話の本当の教訓は日誌にあります。彼らは異常を見つけたとき、**記録した**のです。「いつ、何をしたら、何が起きたか」を書き残す習慣は、80年前から一流のデバッグの基本です。再現手順を書けた時点で、バグの寿命は尽きかけています。
