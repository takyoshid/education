...
## 6. VS Code での Python 開発

1. VS Code をインストール
2. 拡張機能 "Python"(Microsoft 製)をインストール
3. コマンドパレット(`Cmd+Shift+P`)で `Python: Select Interpreter` を選択
4. 仮想環境の Python(`./venv/bin/python`)を選択

これで以下が使えます。

- コード補完(IntelliSense)
- エラーのリアルタイム表示(Pylance)
- デバッガ(レッスン 11 で詳述)
