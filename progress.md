...
| 3 | phase3-dev-tools | Sonnet | ✅ 完了(20ファイル) |
| 4 | phase4-ai-era | Sonnet | ✅ 完了(18ファイル) |
| 5 | phase5-algorithms | Sonnet | ✅ 完了(41ファイル) |
| 6 | phase6-web-frontend | Sonnet | ✅ 完了(58ファイル) |
| 7 | phase7-backend-db | Sonnet | ✅ 完了(38ファイル) |
| 8 | phase8-concurrency-reliability | Codex | ✅ 追加(並行処理・信頼性、障害注入演習、実技試験) |
| 9 | phase9-software-design | Sonnet | ✅ 完了(34ファイル) |
| 10 | phase10-infra-cloud | Sonnet | ✅ 完了(31ファイル) |
| 11 | phase11-distributed-systems | Opus | ✅ 追加(レプリケーション・整合性・分割・キャッシュ・合意) |
| 12 | phase12-projects-oss | Sonnet | ✅ 完了(17ファイル) |
| - | english-track | Sonnet | ✅ 完了(24ファイル) |
| - | 最終レビュー・検収 | Opus | ✅ 完了 |
