...
通常課題とプロジェクトの後に、[Phase 4 実技試験](assessment/)を受験してください。アルゴリズム名の暗記ではなく、未知の依存関係問題をモデル化し、正しさ・決定性・計算量・大規模入力を説明できるかを評価します。
...
1 日 1〜2 問を、Phase 4 開始から Phase 12 までの期間で続ければ、自然に 200 問を超えます。**一気にやろうとせず、毎日に分散してください。**
