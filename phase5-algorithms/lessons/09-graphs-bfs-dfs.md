...
## 💡 コラム: 290年前の橋のパズルが、SNS の基盤になった

1736年、プロイセンの都市ケーニヒスベルクで、市民の間である遊びが流行っていました。「**川にかかる7つの橋を、すべて一度ずつ渡って歩き回れるか?**」誰も成功しないこのパズルに、数学者オイラーが決着をつけます。

彼の天才性は解き方にありました。地形の詳細をすべて捨て、**陸地を「点」、橋を「線」に抽象化**したのです。すると問題は「すべての線を一度ずつなぞれるか」になり、「奇数本の線が集まる点が3つ以上あるから不可能」と証明できました。この瞬間、グラフ理論が誕生しました。

290年後の現在、SNS の友達関係、地図アプリの経路探索、Web ページのリンク、パッケージの依存関係 — すべてこの「点と線への抽象化」の上に動いています。Facebook の2016年の調査では、世界中の任意の2ユーザーは**平均3.57人**を介してつながっているそうです(「6次の隔たり」よりずっと近い)。橋の暇つぶしから始まった数学が、人類のつながりを測っています。
