...
>
> この 2 つの間に依存はありません。Phase 2 さえ終えていれば、どちらからでも始められます。**ただし「どちらか片方でよい」という意味ではありません。**Phase 7 へ進むまでに両方を修了してください。
>
> **先に動く画面を見たい人は Phase 6 から**始めるとよいでしょう。8 週間の理論が続くより、作ったものが動くほうが続きます。
>
> なお面接演習は、**進め方の練習**(問題文を例に変換する、境界条件を書く、総当たりで解く、声に出して説明する)なら Phase 2 修了後から始められます。**パターン演習は、この Phase の該当レッスンを終えてからです。**先に量から入ると解法の暗記になります。
